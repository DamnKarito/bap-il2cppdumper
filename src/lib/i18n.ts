...
const en: TranslationKeys = {
  ...
  about_version: "v5.0", about_description: "IL2CPP binary dumper for Unity games — powered by Rust",
...
const sq: TranslationKeys = {
  ...
  setting_code_registration: "CodeRegistration (hex)",
  setting_metadata_registration: "MetadataRegistration (hex)",
  about_version: "v5.0", about_description: "IL2CPP dumper binar për lojëra Unity — mundësuar nga Rust",
...
const ar: TranslationKeys = {
  ...
  setting_code_registration: "CodeRegistration (hex)",
  setting_metadata_registration: "MetadataRegistration (hex)",
  about_version: "v5.0", about_description: "أداة تفريغ IL2CPP لألعاب Unity — مدعوم بـ Rust",
...
const es: TranslationKeys = {
  ...
  setting_code_registration: "CodeRegistration (hex)",
  setting_metadata_registration: "MetadataRegistration (hex)",
  about_version: "v5.0", about_description: "IL2CPP binary dumper para juegos Unity — impulsado por Rust",
